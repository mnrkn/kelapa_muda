...
<body>
    <h1>Login Admin ke <?php echo get_store_name(); ?></h1>
    <div class="w3l-login-form">
        <h2>Login Akun Admin</h2>
        <!-- Tambahkan bagian HTML khusus untuk login admin di sini -->
        ...
        <?php echo form_open('auth/admin/login/do_login'); ?>
    ...
    <footer>
        <p class="copyright-agileinfo">
            &copy; 2018 <?php echo anchor(base_url(), get_store_name()); ?>
        </p>
    </footer>
</body>
</html>
