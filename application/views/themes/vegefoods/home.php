...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_1.png'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menyediakan Kelapa Terbaik</h1>
            <h2 class="subheading mb-4">Kami Mendapatkan Kelapa Langsung Dari Petani</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_2.png'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Kelapa Segar</h1>
            <h2 class="subheading mb-4">Di Petik Langsung Dari Petani Pilihan</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
  ...
  <div class="container">
    ...
    <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
      ...
      <div id="timer" class="d-flex mt-5">
        ...
        <div class="time pl-3">
          <a class="btn btn-info" href="#products"  class="d-flex justify-content-center align-items-center text-center">
