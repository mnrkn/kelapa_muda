...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Review Order #<?php echo $retur->order_number; ?></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><?php echo anchor(base_url(), 'Home'); ?></li>
                        <li class="breadcrumb-item"><?php echo anchor('customer/retur', 'Review'); ?></li>
                        <li class="breadcrumb-item active">Order #<?php echo $retur->order_number; ?></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php echo anchor('customer/retur/delete/'.$retur->id, 'Hapus', array('class' => 'btn btn-danger')); ?>
            </div>
        </div>
    </div>
</div>
