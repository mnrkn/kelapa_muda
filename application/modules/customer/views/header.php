...
<html lang="ID-id">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- <a href="<?php echo base_url(); ?>" class="brand-link">
        <img src="<?php echo get_store_logo(); ?>" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="sr-only">Nama Toko</span>
    </a> -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/retur'); ?>" class="nav-link">
